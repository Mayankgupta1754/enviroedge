...
const GasChart: React.FC<GasChartProps> = ({ gasData }) => {
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-3 sm:p-6 shadow-lg border border-gray-100/20 transition-all duration-300 hover:shadow-xl hover:bg-gray-100 group h-[420px] sm:h-[600px] dark:bg-slate-900 dark:border-slate-700 dark:hover:bg-slate-800">
      <div className="flex justify-between items-center mb-4">
        <div className="space-y-1">
          <h1 className="text-xl font-bold text-gray-800 group-hover:text-gray-900 dark:text-slate-100 dark:group-hover:text-white">
            Gas Levels
          </h1>
          <p className="text-sm text-gray-500 group-hover:text-gray-600 dark:text-slate-400 dark:group-hover:text-slate-300">
            Real-time Comparison
          </p>
        </div>
      </div>

      <div className="w-full h-[330px] sm:h-[480px]">
